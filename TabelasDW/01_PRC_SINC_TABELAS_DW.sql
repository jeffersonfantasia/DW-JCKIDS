...
CODFORNEC, ESPECIE, CFOP, CST_ICMS, CST_PISCOFINS )';
  ...
  (
     ...
     DT_UPDATE       DATE,
     CONSTRAINT PK_FISCAL PRIMARY KEY (MOVIMENTO, NUMTRANSACAO, CODPROD, CFOP, PERCICMS, CST_ICMS)
  ) ';
  END IF;
  ...
  ON BI_SINC_FISCAL (DATA, NUMNOTA, CODGERENTE, PRODUTO, RAZAOSOCIAL, CST_PISCOFINS)';
  END IF;
