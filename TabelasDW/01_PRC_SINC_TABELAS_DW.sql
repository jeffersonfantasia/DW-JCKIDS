...
BEGIN
  ...
  IF v_index_exists = 0 THEN
    EXECUTE IMMEDIATE 'CREATE INDEX IDX_01 ON BI_SINC_MOV_PRODUTO (CODFILIAL, CODUSUR, NUMTRANSACAO, TEMVENDAORIG, NUMNOTA, DATA, CFOP, CODPROD, CODCLI, CODFORNEC, CODCOB, MOVIMENTO)';
  END IF;
