...
TEMVENDAORIG, CODSUPERVISOR, CODGERENTE, CODFORNEC, DTCANCEL)';
  ...
  (
     ...
     DOCUMENTO       NUMBER(10),
     CONTADEBITO     NUMBER(5),
     CONTACREDITO    NUMBER(5),
     ...
     DTCANCEL        DATE,
     DT_UPDATE      DATE,
     CONSTRAINT PK_MOV_CONTABIL PRIMARY KEY (CODLANC, IDENTIFICADOR)
  )';
  END IF;
...
CONTACREDITO, ATIVIDADE, ORIGEM, ENVIAR_CONTABIL)';
  ...
  (
     ...
     ENVIAR_CONTABIL VARCHAR2(1),
     DT_UPDATE      DATE,
     CONSTRAINT PK_CONTABILIDADE PRIMARY KEY (CODLANC, IDENTIFICADOR, OPERACAO)
  )';
  END IF;
