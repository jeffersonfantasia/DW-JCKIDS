...
BEGIN
    ...
    SET @DEPARTAMENTO = CASE WHEN @DEPARTAMENTO = 'NULL' THEN NULL ELSE @DEPARTAMENTO END
    SET @SECAO = CASE WHEN @SECAO = 'NULL' THEN NULL ELSE @SECAO END
    SET @CATEGORIA = CASE WHEN @CATEGORIA = 'NULL' THEN NULL ELSE @CATEGORIA END
    SET @LINHA = CASE WHEN @LINHA = 'NULL' THEN NULL ELSE @LINHA END
    SET @CODFABRICA = CASE WHEN @CODFABRICA = 'NULL' THEN NULL ELSE @CODFABRICA END
    SET @CODBARRASMASTER = CASE WHEN @CODBARRASMASTER = 'NULL' THEN NULL ELSE @CODBARRASMASTER END
    SET @IMPORTADO = CASE WHEN @IMPORTADO = 'NULL' THEN NULL ELSE @IMPORTADO END
    SET @NCM = CASE WHEN @NCM = 'NULL' THEN NULL ELSE @NCM END
    SET @NCMEX = CASE WHEN @NCMEX = 'NULL' THEN NULL ELSE @NCMEX END
    SET @CERTIFICACAO = CASE WHEN @CERTIFICACAO = 'NULL' THEN NULL ELSE @CERTIFICACAO END
