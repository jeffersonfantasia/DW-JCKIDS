CREATE PROCEDURE SP_INGEST_STGFILIAL
    @CODFILIAL NCHAR(2),
...
BEGIN
	...
	BEGIN
    	IF EXISTS (SELECT 1 FROM STGFILIAL WHERE CODFILIAL = @CODFILIAL)
			BEGIN
				UPDATE STGFILIAL SET EMPRESA = @EMPRESA, FILIAL = @FILIAL WHERE CODFILIAL = @CODFILIAL
			END
    	ELSE
			BEGIN
				INSERT INTO STGFILIAL (CODFILIAL, EMPRESA, FILIAL) VALUES (@CODFILIAL, @EMPRESA, @FILIAL)
			END
	END
END