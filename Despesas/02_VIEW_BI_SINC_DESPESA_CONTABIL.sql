--CREATE OR REPLACE VIEW VIEW_BI_SINC_DESPESA_CONTABIL AS
    ...
    SELECT E.CODEMPRESA,
           ...
           E.CFOP,
           NVL(E.VALOR, 0) VALOR,
           (CASE WHEN C.RECNUM IS NULL  THEN 0 ELSE FUNC_RATEAR_VALOR_POR_CC(E.VALOR, C.RECNUM, NVL(C.CODCC,'0')) END ) VLRATEIO2,
					 NVL(ROUND((E.VALOR * NVL(C.PERCRATEIO, 100) / 100), 4), NVL(E.VALOR, 0)) VLRATEIO,
