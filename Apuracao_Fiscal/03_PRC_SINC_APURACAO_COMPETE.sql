...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- APURACAO COMPETE
      vVALOR_APURADO_COMPETE := ((r.VLCREDITO + NVL(vVALOR_CREDITO_RED_ESCOLHIDO, 0) + NVL(vVALOR_CREDITO_7PERC, 0) +
                                NVL(vVALOR_CRED_PRESUMIDO, 0) + NVL(vVALOR_CRED_DESTINADO_COMERCIO, 0)) -
      ...
      UPDATE BI_SINC_APURACAO_COMPETE
         SET VLCREDITO         = r.VLCREDITO,
             ...
             VLCRED_ALIQPERC   = vVALOR_CREDITO_7PERC,
             VLCRED_PRESUMIDO  = vVALOR_CRED_PRESUMIDO,
